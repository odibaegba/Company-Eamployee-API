...
namespace CompanyEmployees.Utility
{
    public class EmployeeLinks : IEmployeeLinks
    {
        ...
        public LinkResponse TryGenerateLinks(IEnumerable<EmployeeDto> employees, string field, Guid companyId, HttpContext httpContext)
        {
            var shapedEmployees = ShapeData(employees, field);

            if(ShouldGenerateLinks(httpContext))
                return ReturnLinkdedEmployees(employees, field, companyId, httpContext, shapedEmployees);
